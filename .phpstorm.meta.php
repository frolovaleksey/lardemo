...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Services\Author\AuthorRepository' => \App\Services\Author\AuthorRepositoryHandler::class,
            'App\Services\Book\BookRepository' => \App\Services\Book\BookRepositoryHandler::class,
            'App\Services\Cart\Cart' => \App\Services\Cart\CartHandler::class,
            'App\Services\File\BookFile' => \App\Services\File\BookFileHandler::class,
            'App\Services\File\File' => \App\Services\File\FileHandler::class,
            'App\Services\Order\OrderRepository' => \App\Services\Order\OrderRepositoryHandler::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\Server3\OSPanel\home\lardemo\project\public\storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\Server3\\OSPanel\\home\\lardemo\\project\\public\\storage','fortify.guard',
...
'inertia.ssr.url','inertia.testing.ensure_pages_exist','inertia.testing.page_paths','inertia.testing.page_extensions','ide-helper.filename',
...
'api-tokens.update','api-tokens.destroy','sanctum.csrf-cookie','book.index','book.create','book.store','book.show',
'book.edit','book.update','book.destroy','book.update_post','author.index',
'author.create','author.store','author.show','author.edit','author.update',
'author.destroy','checkout','cart.addItem','cart.count','cart.update',
'cart.remove','order.create','order.store','dashboard','storage.local',);
